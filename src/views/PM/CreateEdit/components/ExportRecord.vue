  ...
  <div class="export-record">
    <div class="export-record-header white-bg">
      ...
      <p>
        ...
        <el-button size="small" @click.native="deleteAll">清空所有</el-button>
      </p>
    </div>
    <!-- 记录列表 -->
              ...
              <div class="lists-info">
                ...
                <div class="">
                  ...
                  <el-button
                    ...
                    >下载指标数据</el-button
                  >
                  <el-button size="small" @click.native="deleteSingle(item)"
                    >删除</el-button
                  >
                </div>
              </div>
                ...
                const timer1 = setInterval(() => {
                  if (item.seconds > 0 && item.percentage < 100) {
                    ...
                    item.percentage = parseInt(
                      (1 - item.seconds / initSeconds) * 100
                    )
                  } else {
                    item.seconds = 0
                    item.percentage = 100
